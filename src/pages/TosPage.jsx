...
export default function TosPage() {
    return (
        <>
        <section className="relative h-screen flex flex-col bg-black"> {/* Full viewport height section with black background */}
            <NavBar /> {/* Render the navigation bar */}
            <div className='absolute top-24 bottom-0 right-0 left-0 flex justify-center min-h-full z-20'> {/* Center content within the section */}
                <div className='max-w-[1250px] w-full p-6 rounded-lg shadow-2xl text-white m-6'> {/* Main content container */}
                    <h2 className="text-center text-3xl font-extrabold leading-[1.15] sm:text-5xl"> {/* Page title */}
                        Terms of Service
                    </h2>
                    <div className="my-8 px-10 py-5 bg-gray-200/75 text-black h-[700px] overflow-auto rounded-lg"> {/* Content area with scrollable terms */}
                        ...
                        <ul>
                            <li><p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Brawlz.gg</p></li>
                            ...
                            <li><p><strong>Country</strong> refers to: Victoria, Australia</p></li>
                            <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Brawlz.gg.</p></li>
